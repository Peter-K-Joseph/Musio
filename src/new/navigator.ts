...
class album_manager {
    album_data: Array<any>

    constructor(init_load: boolean = false) {
    ...
    private _init_app() {
        ...
        this.album_data.forEach((album) => {
            ...
            mainCard.addEventListener("click", (e) => {
                this._load_album_info_initmode(e.currentTarget as HTMLElement)
            })
            document.querySelector("#album_list").appendChild(mainCard);
        })
    }

    private _load_album_info_initmode(e: HTMLElement) {
